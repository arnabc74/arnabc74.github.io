...
<HEAD2>Lesson 1, Video 2: Data--types</HEAD2>
...
<HEAD2>Lesson 3, Video 1: Bar, pie</HEAD2>
...
<HEAD2>Lesson 4, Video 1: Pitfalls</HEAD2>
<HEAD2>Lesson 4, Video 2: Real life eamples</HEAD2>
...
<HEAD2>Lesson 1, Video 1: Frequency distribution</HEAD2>
...
<HEAD2>Lesson 1, Video 1: The concept and mean</HEAD2>
...
<HEAD2>Lesson 2, Video 1: Median</HEAD2>
...
<HEAD2>Lesson 3, Video 1: Mode and others</HEAD2>
...
<HEAD2>Lesson 4, Video 1: Robustness</HEAD2>
...
<HEAD2>Lesson 1, Video 2: Range</HEAD2>
...
<HEAD2>Lesson 2, Video 1: Variance and standard deviation</HEAD2>
...
<HEAD2>Lesson 3, Video 1: Mean absolute deviation</HEAD2>
...
<HEAD2>Lesson 4, Video 1: Semi-interquartile range and boxplot</HEAD2>
...
<HEAD2>Lesson 1, Video 1: Bivariate data, The concept via plots</HEAD2>
...
<HEAD2>Lesson 1, Video 2: (Rank) correlation</HEAD2>
...
<HEAD2>Lesson 2, Video 1: Contingency table measures (part 1)</HEAD2>
<HEAD2>Lesson 2, Video 2: Lab</HEAD2>

<HEAD2>Lesson 3, Video 1: Contingency table measures (part 2)</HEAD2>
<HEAD2>Lesson 3, Video 2: Lab</HEAD2>

<HEAD2>Lesson 4, Video 1: Concept of moments: skewness and kurtosis</HEAD2>
