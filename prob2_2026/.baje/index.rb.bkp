...
Here is a assignment 1. If your roll number is <B>bs2xxx</B>, then download the assignment from the following address:
<Q><TT>https://arnabc74.github.io/prob2_2026/a1_bs2xxx.html</TT></Q>
...
You must submit your own handwritten solutions. Discussions are allowed (and even encouraged). You
 must submit before the midsem starts.  This assignment carries 10 marks.
<HEAD2>Marks distribution</HEAD2>
<UL><LI>Midsem: 30</LI><LI>Assignment: 20</LI><LI>End sem: 50</LI></UL>
...
<LI><LINK to="cdistrib1.html">Some standard distributions with
densities</LINK></LI>
<LI><LINK to="cantor.html">Wierd distributions</LINK> (not in
midsem syllabus)</LI>
</OL>
After midsem:
<OL>
...
<LI><LINK to="dirichlet.html">Multinomial and Dirichlet distributions</LINK></LI>
