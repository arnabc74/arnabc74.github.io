...
<OL><EXR>(Easy) If <M>A,B</M>  are independent, then show that <M>A^c,B</M>  are also independent. Are
 <M>A^c,B^c</M>  also independent?</EXR>
<EXR>(Easy) Is it possible to have an event that is independent of itself? If so, find all such
 events. If not, prove why not.</EXR>
<EXR>(Easy) Is it possible to have an event that is independent of all other events? If so, find all such events. If
 not, prove why not.</EXR>
<EXR>(Medium) If <M>A,B</M>  are independent, and <M>A,C</M>  are also independent, then is it true that
 <M>A</M>  and <M>B\cup C</M>  must also be independent?</EXR>
<EXR>(Easy) If <M>A</M>  and <M>B</M>  are mutually exclusive, then must <M>A,B</M>  be
 independent? Must they be dependent?</EXR>
<EXR>(Easy) The numbers <M>-10,...,-1,1,...,10</M>  are written on 20 pieces of papers. One of the papers
...
<EXR>(Medium) Same set up as above. Find an event <M>C</M>  such that <M>A,B,C</M>  are mutually independent.</EXR>
<EXR>(Medium) If <M>A\seq B</M>  are two events, can <M>A,B</M>  be independent?</EXR>
<EXR>(Easy) If <M>P(A_i)=p_i</M>  for <M>i=1,2,3,</M>  and <M>A_i</M>'s are mutually independent,
 then find <M>P(A_1\cup A_2\cup A_3).</M></EXR>
<EXR>(Easy) If two fair dice are rolled independently, find the probability that the first shows a number
 strictly larger than the second. </EXR>
<EXR>(Easy) If two fair dice are rolled independently, find the probability that the first number
divides the second. </EXR>

<EXR>(Medium) <CIMG web="most2.png"/>

Here "in a row" means "consecutively."
<ANS>
...
<EXR>(Easy)<CIMG web="most18.png"/>
<ANS>
<M>2^{-100}{100 \choose 50}\approx 0.08.</M>
</ANS>
</EXR>
<EXR>(Hard)<CIMG web="most20.png"/>
