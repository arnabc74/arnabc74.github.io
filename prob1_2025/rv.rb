...
their probabilities? That would woul be insane, because there are uncountaly infinitely many such subsets. 
...
::<EXR><CIMG web="hpsrv1.png"/></EXR>
In all the following problems the term "density" stands for "PMF".
::<EXR><CIMG web="hpsrv2.png"/></EXR>
::<EXR><CIMG web="hpsrv3.png"/></EXR>
::<EXR><CIMG web="hpsrv4.png"/></EXR>
::<EXR><CIMG web="hpsrv5.png"/></EXR>
::<EXR><CIMG web="hpsrv6.png"/></EXR>
::<EXR><CIMG web="hpsrv7.png"/></EXR>
The nex two problems refer to the following CDF:
<CIMG web="hpsmore1.png"/>
::<EXR><CIMG web="hpsmore2.png"/></EXR>
::<EXR><CIMG web="hpsmore3.png"/></EXR>
::<EXR><CIMG web="hpsmore4.png"/></EXR>
