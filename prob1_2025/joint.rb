...
::<EXR>(Easy)Let <M>X_1,X_2,...,X_n</M>  be identically distributed independent random variables with <M>V(X_1) = \sigma^2 < \infty.</M>  Then what is 
...
::<EXR>(Easy)<CIMG web="jt1.png"></CIMG>
...
::<EXR>(Medium)<CIMG web="jt2.png"></CIMG>
...
::<EXR>(Easy)<CIMG web="jt3.png"></CIMG>
<ANS>
<M>E(X) = [[N2]]</M>  and <M>V(X) = [[N(2n+1)][6]]-[[N^2][4]] = [[N^2+2N][12]]. </M>
</ANS>
</EXR>
::<EXR>(Medium)<CIMG web="jt4.png"></CIMG>
...
::<EXR>(Medium)<CIMG web="jt5.png"></CIMG>
<ANS>
...
::<EXR>(Easy)<CIMG web="jt6.png"></CIMG>
<ANS>
<M>E(2X+3Y) = 2E(X)+3E(Y)</M>  and <M>V(2X+3Y) = 4V(X)+9V(Y).</M>
</ANS>
</EXR>
::<EXR>(Medium)<CIMG web="jt7.png"></CIMG>
<ANS>
...
::<EXR>(Medium)<CIMG web="jt8.png"></CIMG>
<ANS>
...
::<EXR>(Hard)<CIMG web="jt9.png"></CIMG>
<ANS>
(a) 1.
...
::<EXR>(Easy)<CIMG web="jt10.png"></CIMG>
<ANS>
...
::<EXR>(Easy)<CIMG web="jt11.png"></CIMG>
<ANS>
...
::<EXR>(Hard)<CIMG web="jt14.png"></CIMG>
<ANS>
...
::<EXR>(Hard)<CIMG web="jt15.png"></CIMG>
<ANS>
...
::<EXR>(Medium)<CIMG web="jt16.png"></CIMG>
