...
<EXR>If <M>A_1\seq A_2\seq A_3,</M>  then show that <M>P(A_1\cup A_2\cup A_3) = P(A_1)+P(A_2\cap A_1^c)+P(A_3\cap A_2^c).</M></EXR>
...
More precisely, 
<D>
\sum_{|\alpha|=r} P(A_\alpha) = \sum_{k=1}^n \binom{k}{r}
\sum_{|\beta|=k} P(B_\beta).
</D>
[Thanks to Sayantan for pointing out a couple of "not so trivial" typos here.]
<P/>
