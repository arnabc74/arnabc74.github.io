...
<HEAD3>Exercises about first time visits</HEAD3>
<EXR>Consider a simple, symmetric random walk starting from 0. What is the chance it visits 2 for
...
<EXR>Let <M>r,n\in\nn</M> with <M>r\leq n</M>.   Consider a simple, symmetric random walk starting from 0. Then
...
<HEAD3>Exercises regarding never returning to 0</HEAD3>
