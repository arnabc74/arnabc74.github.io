...
::<EXR>(Medium) <EIMG web="morecond10.png"></EIMG><HR/></EXR>
...
<HR/></EXR>
::<EXR>(Hard) <EIMG web="morecond12.png"></EIMG><HR/></EXR>
::<EXR>(Hard) <EIMG web="morecond13.png"></EIMG><HR/></EXR>
::<EXR>(Medium) <EIMG web="morecond14.png"></EIMG><HR/></EXR>
::<EXR>(Medium) <EIMG web="morecond15.png"></EIMG><HR/></EXR>
::<EXR>(Hard) <EIMG web="morecond16.png"></EIMG><HR/></EXR>
::<EXR>(Hard) <EIMG web="morecond17.png"></EIMG><HR/></EXR>
::<EXR>(Medium) <EIMG web="morecond18.png"></EIMG><HR/></EXR>

::<EXR>(Medium) <EIMG web="morecond19.png"></EIMG><HR/></EXR>
::<EXR>(Hard) <EIMG web="morecond20.png"></EIMG><HR/></EXR>
