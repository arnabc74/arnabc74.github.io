...
::<EXR>(Easy)A box has 6 red balls an 4 black balls. An SRSWR of
...
::<EXR>(Easy)Let <M>N</M> be a positive integer. Let 
<D>
...
::<EXR>(Medium)An SRSWR of size 2 is drawn from <M>\{1,2,...,12\}.</M>
...
::<EXR>(Medium)An SRSWR of size <M>n</M> is selected
...
::<EXR>(Medium)<CIMG web="rossexp1.png"></CIMG>
<ANS>
...
::<EXR>(Medium)<CIMG web="rossexp2.png"></CIMG>
<ANS>
...
::<EXR>(Medium)<CIMG web="rossexp3.png"></CIMG>
<ANS>
