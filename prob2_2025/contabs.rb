 @{<NOTE>
<TITLE>Absolutely continuous distribution</TITLE>
<HEAD1>Basics</HEAD1>
...
Any such <M>f</M>  is called a <TERM>probability density function (PDF)</TERM>  (or, more simply,
a <TERM>density</TERM>)  of <M>X.</M>  
</DEFN>
