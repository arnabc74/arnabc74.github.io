...
The main use of the beta distribution in statistics is as a "distribution of probability". To
 ...
 <M>\Pi</M>, being a probability, must have a distribution supported on on <M>[0,1].</M>  Also,
...
Imagine a gas without any overall flow. We know that the molecules are moving tis way and that
 ...
 did a briliant logical argument starting with little more than common sense notions available to anybody. 
