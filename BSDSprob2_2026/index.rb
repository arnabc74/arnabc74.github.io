...
<BR/><B>Topics to be covered:</B>  Box-Muler transform with proof, inverse CDF method, rejection sampling.
...
<UL><LI>Raunak, Smaridddha, Pardha Sarathi</LI>
<LI>Sai Krishna, Vansh, Siddhant</LI>
<LI>Arka, Ashish, Satyaprakash</LI>
</UL>
</LI>
...
<B>Resource:</B>  <LINK
 to="https://www.youtube.com/playlist?list=PLx--gUxue3Z-QL_BG8VeN4Ji1JcH7jUMK">See this youtube playlist</LINK>. Also you
...
<LI>Manvi, Nehal, Mayank, Sourish, Tenzing</LI>
<LI>Harsh, Shyam, Ketan, Maharshi, Sejal</LI>
<LI>Gagan (B), Garg, Lakshmi Narayna, Manish, Parnika</LI>
</UL>
</LI>
...
<BR/>
<B>Resource:</B>  <LINK
 to="https://sites.google.com/site/countminsketch/home/expositions">This page</LINK>  contains
 expository articles on the topic.
<UL><LI><RED><TICK/></RED>Shinjan M, Anmol, Ankesh, Danish</LI>
<LI>Aarav, Diksha, Disha, Divyansh, Gagan (D)</LI>
<LI>Pritham, Priyansh,  Chinmay, Rishikesh, Sagnik</LI>
</UL>
</LI>
<LI>BJKST algorithm for counting distinct elements from an input stream.
<UL><LI>Daksh, Tridham, Sandip, Shaurya, Shinjan G</LI></UL>
</LI>
<LI>Showing almost every number is a normal number.
<UL><LI><RED><TICK/></RED>Priyanshu, Shreyas, Mahima, Abhinav, Pawan</LI>
<LI>Saurav, Jeevantej, Varshini, Siva Lakshmi, Manogna</LI>
</UL>
</LI>
<LI>Showing that a random walk in 3D may not return.
<UL><LI><RED><TICK/></RED>Swapnil</LI>
<LI>Aditya, Antarip, Akshay</LI>
<LI>Lakshya, Utkarsh Omhari</LI>
<LI>Vinay, Siva Ganesh, Abinaya</LI>
</UL>
</LI>
</OL>
