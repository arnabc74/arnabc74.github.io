...
<EXR>Let <M>X\sim Binom(n,p).</M>  Find a variance stabilising transform for <M>[[Xn]].</M></EXR>
<EXR>Let <M>X\sim</M> Exponential distribution with rate <M>\lambda</M>.  Find a variance
 stabilising transform for <M>X.</M></EXR>
...
<EXR>Prove the following theorem using the Cramer-Wold device. 
