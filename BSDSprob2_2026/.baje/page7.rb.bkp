...
Let <M>\phi</M>  be the CF corresponding to the  the distribution function <M>F.</M>  Let
 <M>\phi</M>  be absolutely integrable. Then <M>F</M> 
 has a bounded continuous density <M>f</M>  given by
<D>f(x) = [[1][2\pi]]\int_{-\infty}^\infty e^{-itx} \phi(t)\, dt.</D>
</THM>
<EXM>Normal and Cauchy density</EXM>
...
<EXR>Check the Fourier inversion formula for <M>X\sim</M> exponential with rate <M>1.</M> </EXR>
</NOTE>@}
