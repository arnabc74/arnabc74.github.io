...
::<EXR>Let <M>X_1,...,X_{p+1}</M>  be independent with <M>X_i\sim Gamma(1,\alpha_i).</M>  Let
 <M>S=X_1+\cdots+X_{p+1}.</M>  Then show that 
...
::<EXR><EIMG web="wilks3.png"/>

This exercise is from a very old book, that uses a definition of multinomial notationally different from the modern defintion
 that we are using. If we roll a <M>6</M>-faced die with probabilities <M>p_1,...,p_6</M>
 independently <M>n</M>  times, and <M>X_i = </M>  number of times face <M>i</M>  shows up, then
 we shall write <M>(X_1,...,X_6)\sim Multinom(n,p_1,...,p_6).</M>  But this book will write
 <M>(X_1,...,X_5)\sim m(n,p_1,...,p_5).</M>  In this notation, <M>X_1+\cdots+X_5\leq n</M>  and <M>p_1+\cdots+p_5\leq 1.</M>  
</EXR>
