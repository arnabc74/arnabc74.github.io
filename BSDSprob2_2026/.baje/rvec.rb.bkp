...
from which we should be able to work out the dispersion from any desired direction. To achieve 
 this, imagine a ruler placed on the scatterplot with its 0 mark at the origin. See <LINK to="https://acbsds.shinyapps.io/varmat/">this
 demo</LINK>  for better understanding. Parallel rays of
