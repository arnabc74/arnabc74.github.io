...
<PROJ><NAME>Count-min sketch</NAME><DESCR>
...
So far as probability theory goes, it is a use of the Markov inequality. But before you get into
...
<PROJ><NAME>BJKST algorithm for counting distinct elements</NAME><DESCR>
The set up is just like that for the last project. But here the aim is to estimate the number of
 unique categories seen so far (and not the frequency of any given category). 
