...
Then <M>X = X^+-X^-,</M>  and both <M>X^+</M>  and <M>X^-</M>  are nonnegative random variables. We define
<D>E(X) = E(X^+)-E(X^-)</D>
...
This definition is quite natural, and does not care about the size of the probability space. In
 fact, it works for any measure. When used for a general measure, we call it the <TERM>Lebesgue integral</TERM>.  
</NOTE>@}
