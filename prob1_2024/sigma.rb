...
When we learn probabaility theory we encounter the following
axioms:
...
One obvious example of a <M>ss</M>-algebra on any non-empty
set <M>\Omega</M> is its power set, the collection of all
possible subsets. 
<P/>
What strikes a beginning student of probability as odd is the
need 
...
<Q>
Let <M>\Omega</M> denot the set of all points on the
circumference of the wheel.
If <M>f_\theta </M> is the function that denotes rotation by an
...
subsets of <M>\Omega</M> (instead of <I>all</I> subsets). Now
...
<DISQUSE url="https://arnabc74.github.io/q/sigma.html" id="vit"/></E>@}
</NOTE>
