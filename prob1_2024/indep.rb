...
the <M>A_i</M>', say <M>A_1, A_4</M> and <M>A_7,</M> then their
...
<M>A_2\seq \Omega_2</M>  we have <M>P(A_1\cap A_2)  = P(A_1)P(A_2).</M>
</THM>
<PF>
...
Then we want a probability <M>P</M>  on <M>\Omega</M>  such that for any <M>A_{n_i}\seq \Omega_{n_i}</M>  for <M>i=1,...,k</M> 
 we have them mutually indepndent under <M>P.</M>  Such a <M>P</M>  indeed exists adn is unique. Unfortunately,
