...
<EXM><EBODY>dharo @{<M>X=\{a,b,c\}.</M>@} tAr ei kayTA @{<E>subset</E>@}  nilAm, 
...
<SOLN/>h,nyA. kAraN @{<M>\phi</M>@}  Ar @{<M>X </M>@} dujanei Achhe. yatarakam
 @{<E>intersection</E>@}  Ar @{<E>union</E>@}  sambhab, tArAo Achhe. </EXM>
...
<LI>neither open nor closed in <M>\rr</M></LI>
 ...
 @{<E>neighbourhood</E>@}  @{<M>K</M>@}-r madhye nei. tAi @{<E>open</E>@}  bA @{<E>closed</E>@}  konoTAi nay.</EXM>
...
<LI><M>A\cup\{3\}.</M></LI>
 ...
 @{<E>set</E>@}-er bAire. tAi uttar habe @{<M>A\cup\{1\}.</M>@}</EXM>
...
</E>@}</EBODY><SOLN/>sheSerTAi khAli bhul, kAraN @{<E>first countable</E>@}  nay.</EXM>
@{<HEAD2>General</HEAD2>@}
...
<LI><M>\tau_1\cap \tau_2 = \{\rr^2,\phi\}.</M></LI>
 ...
 @{<E>rectangle</E>@}  DhokAno yAy, eba.n tAr ul+ToTAo karA sambhab. tAi @{<M>\tau_1 = \tau_2.</M>@}</EXM>
...
<LI><M>A</M> must be an open set.</LI>
 ...
 nambarer janya @{<E>counterexample</E>@}  habe @{<M>\rr</M>@}-er madhye @{<M>\qq.</M>@}  </EXM>
...
</E>@}</EBODY><SOLN/>sheSerTA bhul, kAraN @{<M>A</M>@}-ke @{<E>open</E>@}  hatei habe.</EXM>
