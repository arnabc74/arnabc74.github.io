...
estimation technique. Check by rotating the image by that angle.</LI>
...
long term average and standard deviation for each of them.  </LI>
...
shuffles are needed to reeach complete mixing.</LI>
